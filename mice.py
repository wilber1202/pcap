...
def main():
    ...
    if (0 == os.stat(DataFileName).st_size):
        print("empty mice file")
        exit(1)
    ...
    ax1.set_title('[%s]-[%s] Author : wilber' % (pcapFilePath, action))
    ax1.scatter(X, Y, c='r', marker='o')
    picname = "picture_" + action.lower() + ".jpg"
    plt.savefig(picname)
    #plt.show()
    
    print("mice analysis done")
